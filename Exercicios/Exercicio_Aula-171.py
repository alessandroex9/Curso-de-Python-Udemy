...
#Essa solução funciona em qualquer linguagem de programação
lista_soma = []
...
Uma delas foi usando zip para unir duas listas e utilizar list comprehension
para fazer a conta:
